...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [_FN5] = KEYMAP(
     ...
     _____,      KC_MS_LEFT,      KC_MS_DOWN,      KC_MS_RIGHT,    _____,    _____,    _____,    _____,    _____,    _____,    _____,
     KC_MS_BTN1,      _____,      _____,      _____,    _____,    _____,    _____,    _____,    _____,    KC_MS_BTN2,    _____,
     _____,      _____,      _____,            _____,        _____,         _____,                   _____,    _____
   )
};
